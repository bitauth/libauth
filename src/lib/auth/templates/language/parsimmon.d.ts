/* eslint-disable @typescript-eslint/unified-signatures, no-redeclare, @typescript-eslint/no-unnecessary-qualifier, @typescript-eslint/no-unused-vars, functional/no-method-signature, no-shadow, init-declarations */
// cSpell:disable
