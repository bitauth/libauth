...
export enum AuthenticationErrorCommon {
  ...
  exceededMaximumControlStackDepth = 'Program exceeded the maximum control stack depth (100 items).',
  ...
  schnorrSizedSignatureInCheckMultiSig = 'Program used a schnorr-sized signature (65 bytes) in a legacy-mode OP_CHECKMULTISIG operation.',
