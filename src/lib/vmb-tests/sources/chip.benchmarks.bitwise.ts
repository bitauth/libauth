...
export default [
  [
    ...
    [
      ...
      ['', `<1> ${minNumber} OP_LSHIFTNUM`, ' invalid OP_LSHIFTNUM (by min_number)', ['chip_bitwise', 'p2sh_ignore']],
      ...
      ['<$(<0> <10> OP_NUM2BIN)>', `OP_DROP ${maxNumber} OP_DUP OP_RSHIFTNUM <0> OP_EQUAL`, 'max-cost OP_RSHIFTNUM (max_number >> max_number)', ['chip_bitwise', 'p2sh_ignore']],
