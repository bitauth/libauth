...
export default [
  [
    ...
    [
      ...
      ['<0xffffffff>', `${repeat('OP_DUP OP_CAT', 11)} OP_DUP OP_ADD`, 'Within BCH_2025_05 P2SH/standard, single-input limits, maximize OP_ADD operand bytes', ['2023_invalid', 'nop2sh_ignore'], minimalScenarioStandard],
      ['<0xffffffff>', `${repeat('OP_DUP OP_CAT', 7)} OP_DUP OP_2DUP ${repeat('OP_3DUP', 24)} ${repeat('OP_ADD', 75)}`, 'Within BCH_2025_05 P2SH/standard, single-input limits, balance OP_ADD density and operand bytes', ['2023_invalid', 'nop2sh_ignore'], minimalScenarioStandard],
