...
export default [
  [
    ...
    [
      ...
      // ['<0xff> <8052>', `OP_NUM2BIN OP_REVERSEBYTES <0xff> OP_DIV`, 'Within BCH_2025_05 P2SH20/standard, single-input limits, maximize 1-byte OP_DIV (1-by-8052 byte) (highest byte set)', ['2023_invalid', 'nop2sh_ignore', 'p2sh32_ignore'], minimalScenarioStandard],

      // ['<0xff> <8048>', `OP_NUM2BIN OP_REVERSEBYTES <0xff> OP_DIV`, 'Within BCH_2025_05 P2SH32/standard, single-input limits, maximize 1-byte OP_DIV (1-by-8048 byte) (highest byte set)', ['2023_invalid', 'nop2sh_ignore', 'p2sh20_ignore'], minimalScenarioStandard],
