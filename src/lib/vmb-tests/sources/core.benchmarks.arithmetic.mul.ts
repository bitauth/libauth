...
export default [
  [
    ...
    [
      ...
      ['<0xff> <194>', `OP_NUM2BIN OP_REVERSEBYTES OP_DUP OP_MUL`, 'Within BCH_2025_05 P2SH/standard, single-input limits, maximize square OP_MUL (194-by-194 byte) (highest byte set)', ['2023_invalid', 'nop2sh_ignore'], minimalScenarioStandard],
      ['<0xff> <7873>', `OP_NUM2BIN OP_REVERSEBYTES OP_16 OP_MUL`, 'Within BCH_2025_05 P2SH20/standard, single-input limits, maximize top-operand OP_MUL (1-by-7873 byte) (highest byte set)', ['2023_invalid', 'nop2sh_ignore', 'p2sh32_ignore'], minimalScenarioStandard],
      ['<0xff> <7868>', `OP_NUM2BIN OP_REVERSEBYTES OP_16 OP_MUL`, 'Within BCH_2025_05 P2SH32/standard, single-input limits, maximize top-operand OP_MUL (1-by-7868 byte) (highest byte set)', ['2023_invalid', 'nop2sh_ignore', 'p2sh20_ignore'], minimalScenarioStandard],
      ['<0xff> <8032>', `OP_NUM2BIN OP_REVERSEBYTES <0xff> OP_MUL`, 'Within BCH_2025_05 P2SH20/standard, single-input limits, maximize 1-byte OP_MUL (1-by-8032 byte) (highest byte set)', ['2023_invalid', 'nop2sh_ignore', 'p2sh32_ignore'], minimalScenarioStandard],
      ['<0xff> <8028>', `OP_NUM2BIN OP_REVERSEBYTES <0xff> OP_MUL`, 'Within BCH_2025_05 P2SH32/standard, single-input limits, maximize 1-byte OP_MUL (1-by-8028 byte) (highest byte set)', ['2023_invalid', 'nop2sh_ignore', 'p2sh20_ignore'], minimalScenarioStandard],
    ],
  ],
