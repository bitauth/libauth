  ...
  [
    ...
    [
      ...setExpectedResults(generateTestCases(['<1>', '$0', '$0 in locking bytecode'], [disabledOps]), {
        'OP_2DIV in locking bytecode': ['skip'],
        'OP_2MUL in locking bytecode': ['skip'],
        'OP_INVERT in locking bytecode': ['2025_invalid'],
        'OP_LSHIFT in locking bytecode': ['invalid'],
        'OP_RESERVED in locking bytecode': ['invalid'],
        'OP_RESERVED1 in locking bytecode': ['skip'],
        'OP_RESERVED2 in locking bytecode': ['skip'],
        'OP_RETURN in locking bytecode': ['invalid'],
        'OP_RSHIFT in locking bytecode': ['invalid'],
        'OP_VER in locking bytecode': ['invalid'],
        'OP_VERIF in locking bytecode': ['skip'],
        'OP_VERNOTIF in locking bytecode': ['skip'],
      }),
      ...
      ...setExpectedResults(generateTestCases(['<0>', 'OP_IF $0 OP_ENDIF <1>', 'Unexecuted $0 in locking bytecode'], [disabledOps]), {
        'Unexecuted OP_2DIV in locking bytecode': ['2025_invalid'],
        'Unexecuted OP_2MUL in locking bytecode': ['2025_invalid'],
        'Unexecuted OP_INVERT in locking bytecode': ['2025_invalid'],
        'Unexecuted OP_LSHIFT in locking bytecode': ['2025_invalid'],
        ...
        'Unexecuted OP_RSHIFT in locking bytecode': ['2025_invalid'],
