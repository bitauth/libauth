  ...
  [
    ...
    [
      ...
      ...setExpectedResults(
        ...
        {
          'OP_PUSHDATA_1 of 255 non-zero bytes produces expected stack item': ['p2s_nonstandard'],
          'OP_PUSHDATA_1 of 255 zero bytes produces expected stack item': ['p2s_nonstandard'],
          ...
          'OP_PUSHDATA_2 of 256 non-zero bytes produces expected stack item': ['p2s_nonstandard'],
          'OP_PUSHDATA_2 of 256 zero bytes produces expected stack item': ['p2s_nonstandard'],
      ...
      ...setExpectedResults(
        ...
        ),
        {
          ...
          '<1> OP_IF OP_PUSHDATA_2 ... OP_ENDIF in locking bytecode': ['p2s_nonstandard'],
        },
      ),
    ],
  ],
