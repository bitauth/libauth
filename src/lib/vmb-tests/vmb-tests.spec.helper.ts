...
export const vms = {
  ...
  bch_chip_bitwise_nonstandard: baseVms.bch_2026_nonstandard,
  bch_chip_bitwise_standard: baseVms.bch_2026_standard,
  bch_chip_eval_nonstandard: baseVms.bch_spec_nonstandard,
  bch_chip_eval_standard: baseVms.bch_spec_standard,
  bch_chip_functions_nonstandard: baseVms.bch_2026_nonstandard,
  bch_chip_functions_standard: baseVms.bch_2026_standard,
